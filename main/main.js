...
;(function(name, factory) {
  ...
  // const convertButton = document.getElementById("play");
  
  // convertButton.addEventListener('click', speakText);
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    recognition.addEventListener("result", function (event) {
        ...
        allRecognizedText = document.getElementById("text").value;
          console.log("all:" + allRecognizedText);
        }
